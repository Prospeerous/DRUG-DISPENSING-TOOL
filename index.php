      ...
      <div class="container">
        <div class="top_contact-container">
          <div class="tel_container">
            <a href="">
              <img src="images1/telephone-symbol-button.png" alt=""> Call : +01 1234567890
            </a>
          </div>
          <div class="social-container">
            <a href="">
              <img src="images1/fb.png" alt="" class="s-1">
            </a>
            <a href="">
              <img src="images1/twitter.png" alt="" class="s-2">
            </a>
            <a href="">
              <img src="images1/instagram.png" alt="" class="s-3">
            </a>
          </div>
        </div>
      </div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="buy.html"> Shop online </a>
                </li>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images1/heart.jpeg" alt="" width="400" height="300">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      Welcome To Heartland Pharmacy </h1><br>
                      <h2>Where every heartbeat counts!<br>
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
               We are reliable in our delivery. Trust heartland to take care of your heart!
            </p>
          </div>
        </div>
        <div class="box">
        ...
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              We are available any time any day.
            </p>
          </div>
        </div>
      </div>
